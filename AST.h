...
namespace AST {
    ...
    protected:
        static std::map<std::string, ClassStruct*> classTable, builtinTypes, builtinIdents;
	int first_line, first_col, last_line, last_col;
        std::string filename;
	
	void json_indent(std::ostream& out, unsigned int indent);
        void json_head  (std::ostream& out, unsigned int &indent, std::string const &node_kind);
        void json_close (std::ostream& out, unsigned int &indent);
        void json_child (std::ostream& out, unsigned int indent, std::string const &field, ASTNode *child);
        void json_string(std::ostream& out, unsigned int indent, std::string const &field, std::string const &str);
        void json_int   (std::ostream& out, unsigned int indent, std::string const &field, unsigned int val);
        template<class NodeType>
        void json_list  (std::ostream& out, unsigned int indent, std::string const &field, std::vector<NodeType> const& list);
	ClassStruct *addBuiltinType(std::string name, ClassStruct* super);
	void addBuiltinIdent(std::string name, ClassStruct *type);
	MethodStruct *addBuiltinMethod(ClassStruct *clazz, std::string name, ClassStruct *type, std::vector<ClassStruct*> const &argTypes);
    };
	...
	std::string getType() const;
        ...
        void setMethodStruct(MethodStruct* methodStruct) { this->methodStruct_ = methodStruct; }
    };
	...
	std::vector<Method*>* getMethods() const { return mthds_; }
        std::vector<Statement*>* getStatements() const { return stmts_; }
        std::vector<TypedArg*>* getArgs() const { return args_; }
        void setClassStruct(ClassStruct* classStruct) { this->classStruct_ = classStruct; }
    };
    ...
    public:
        ...
        virtual void updateTypes(ClassStruct *thisClass, MethodStruct *thisMethod, bool &changed, bool &failed) final override;
        virtual ClassStruct *getType(ClassStruct *thisClass, MethodStruct *thisMethod, bool &failed) = 0;
	virtual void getVars(std::vector<std::string> &vars, std::vector<std::string> &fields, std::map<std::string, std::pair<ClassStruct*, bool>> &varTable, std::map<std::string, std::pair<ClassStruct*, bool>> &fieldTable, bool inConstructor, bool &failed) override {}
    };   
    ...
    public:
        ...
        virtual void getVars(std::vector<std::string> &vars, std::vector<std::string> &fields, std::map<std::string, std::pair<ClassStruct*, bool>> &varTable, std::map<std::string, std::pair<ClassStruct*, bool>> &fieldTable, bool inConstructor, bool &failed) override;
        virtual void updateTypes(ClassStruct *thisClass, MethodStruct *thisMethod, bool &changed, bool &failed) override;
        virtual void json(std::ostream &out, unsigned int indent = 0);
    };
	...
	virtual void json(std::ostream &out, unsigned int indent = 0);
        ...
        virtual bool isThis() const override { return !isField_ && name_ == "this"; }
        bool isAssignable() const;
        std::string getName() const { return name_; }
        virtual void getVars(std::vector<std::string> &vars, std::vector<std::string> &fields, std::map<std::string, std::pair<ClassStruct*, bool>> &varTable, std::map<std::string, std::pair<ClassStruct*, bool>> &fieldTable, bool inConstructor, bool &failed) override;
        virtual ClassStruct *getType(ClassStruct *thisClass, MethodStruct *thisMethod, bool &failed) override;
    };
    ...
    public:
        ...
        virtual ClassStruct *getType(ClassStruct *thisClass, MethodStruct *thisMethod, bool &failed) override { return this->builtinTypes["Int"]; }
        virtual void json(std::ostream &out, unsigned int indent = 0);
    };
    ...
    public:
        ...
        virtual ClassStruct *getType(ClassStruct *thisClass, MethodStruct *thisMethod, bool &failed) { return this->builtinTypes["String"]; }
        virtual void json(std::ostream &out, unsigned int indent = 0);
    };
